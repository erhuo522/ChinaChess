...
int test_plate_locate() {
  ...
  const string file = "../../data/resources/image/test.jpg";
...
int test_plate_judge() {
  ...
  cv::Mat src = imread("../../data/resources/image/plate_judge.jpg");
...
int test_plate_detect() {
  ...
  cv::Mat src = imread("../../data/resources/image/plate_detect.jpg");
...
int test_plate_recognize() {
  ...
  Mat src = imread("../../data/resources/image/test.jpg");
