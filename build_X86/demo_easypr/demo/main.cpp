...
int accuracyTestMain() {
  ...
  kv->load("../../data/etc/chinese_mapping");

  bool isExit = false;
  while (!isExit) {
    easypr::Utils::print_file_lines("../../data/etc/batch_test_menu");
    ...
    while (isRepeat) {
      ...
      switch (select) {
        case 1:
          accuracyTest("../../data/resources/image/general_test");
          break;
        case 2:
          accuracyTest("../../data/resources/image/native_test");
          break;
        case 3:
          isExit = true;
          break;
...
int testMain() {
  ...
  bool isExit = false;
  while (!isExit) {
    Utils::print_file_lines("../../data/etc/test_menu");
    std::cout << kv->get("make_a_choice") << ":";
...
int main(int argc, const char* argv[]) {
  ...
  bool isExit = false;
  while (!isExit) {
    easypr::Utils::print_file_lines("../../data/etc/main_menu");
    std::cout << kv->get("make_a_choice") << ":";
    ...
    while (isRepeat) {
      ...
      switch (select) {
        ...
        case 5:
          ...
          break;
        case 6: {
          easypr::Utils::print_file_lines("../../data/etc/dev_team");
          break;
        }
        case 7: {
          easypr::Utils::print_file_lines("../../data/etc/thanks");
          break;
        }
        case 8:
          isExit = true;
